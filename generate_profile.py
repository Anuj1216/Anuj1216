...
INFO = [
    ("__header__", "Anuj Acharya", ""),
    ("__rule__", "", ""),
    ("Role",     "Web Developer / Java", "val"),
    ("Edu",      "B.Sc. CSIT, MMAM Campus · Class of 2079", "val"),
    ("Focus",    "Java Developer · Angular · SpringBoot · Full-Stack", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Core",     "Angular.js  · JavaScript (ES6+)", "val"),
    ("Styling",  "HTML5 · CSS3", "val"),
    ("Backend",  "MySQL · SpringBoot(Learning)", "val"),
    ("Cloud",    "Firebase · Vercel", "val"),
    ("Tools",    "Git & GitHub · OpenAI", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),
    ("InternTrack",    "Internship Tracking Website for students (Java, Spring Boot, Angular)", "warn"),
    ("YatraDristi",    "Intelligent Road Safety & Risk Prediction System (Python)", "warn"),
    ("LKS Hub", "Loksewa Study Platform(HTML, CSS, JS, Firebase)", "warn"),
    ("Portfolio",  "Personal Portfolio Site(Angular)", "warn"),
    ("__blank__", "", ""),
    ("__section__", "~/highlights", ""),
    ("Cert",     "WordPress · Navigating AWS", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("Web",      "acharyaanuj.com.np", "accent"),
    ("LeetCode",      "leetcode.com/anujacharya", "accent"),
    ("LinkedIn", "linkedin.com/in/anuj-a-3999232a4/", "accent"),
    ("Mail",     "acharyaanuj45@gmail.com", "accent"),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8"> Web Developer / Java FullStack </tspan>'
